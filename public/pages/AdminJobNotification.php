...
<html>
  <head>
    ...
    <title>New Job Application Notification Email</title>
    <style>
      /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Hi,</p>
                        <p>{{name}} has posted a new job on the portal for {{shiftdate}} looking for {{totalStaff}} workers.</p>
                        <p> You can review the applications by logging into the Portal.</p>
