...
<html>
  <head>
    ...
    <title>Shift Cancelled Email</title>
    <style>
      /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Hello {{name}},</p>
                        <p>Your shift with {{data.clientId.firstName}} {{data.clientId.lastName
                        }} has been cancelled. We are sorry for any inconvenience this may have caused.</p>
