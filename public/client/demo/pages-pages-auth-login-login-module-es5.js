...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-pages-auth-login-login-module"], {
  ...
  function srcAppPagesPagesAuthLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function LoginComponent_mat_icon_22_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "mat-icon", 20);
      }

      if (rf & 2) {
        var ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("icIcon", ctx_r1.icVisibility);
      }
    }
    ...
    function LoginComponent_mat_icon_23_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("icIcon", ctx_r2.icVisibilityOff);
      }
    }
    ...
    function LoginComponent_mat_progress_spinner_32_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "mat-progress-spinner", 21);
      }
    }
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(router, fb, cd, authService, snackbar) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    this.loading = true;
                    _context.next = 3;
                    return this.authService.getAllUserAuth();
                  ...
                  case 5:
                    console.log('---- send -----'); // await this.authService.getAll();

                    adminUser = this.authService.AllUser.filter(function (ele) {
                      return ele.emailAddress == 'admin@admin.com';
                    });
                  ...
                  case 12:
                    console.log('1');
                    this.authService.login(controls.emailAddress.value, controls.hash.value).subscribe(function (user) {
                      if (user) {
                        console.log('log');
                        ...
                        _this.authService.loggedInType = txt;
                        _this.authService.currenctUser = user;
                        localStorage.setItem('userInfo', JSON.stringify(user)); // this.authService.getAllJobAuth();

                        console.log("7 1_JOB 7");

                        if (user['accountType'] == 'Client') {
                          _this.authService.getClientJob(user['_id']).subscribe(function (res) {
                            _this.authService.setClientJobLocal(res);

                            console.log('cccc');
                            console.log(res);
                            console.log(_this.authService.clientJob);
                            if (user['clientType'] == 'User' || user['clientType'] == 'Admin') _this.authService.getParent(user['parentId']).subscribe(function (res1) {
                              _this.authService.setCurrentParentLocal(res1);

                              console.log('cccc');
                              console.log(res1);
                              console.log(_this.authService.currentParent);

                              _this.snackbar.open('Logged in Successfully', 'Cancel', {
                                duration: 10000
                              });
                          ...
                          _this.authService.getWorkerJob(user['_id']).subscribe(function (res2) {
                            _this.authService.setCurrentWorkerJobLocal(res2);

                            console.log('ddd');
                            console.log(res2);
                            console.log(_this.authService.workerJobInfo);
                        ...
                        } else _this.router.navigate(['/admin']);
                      } else {
                        _this.snackbar.open('You have to Input Email & Password correctly ', 'Cancel', {
                          duration: 10000
                        });
    ...
    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      template: function LoginComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](22, LoginComponent_mat_icon_22_Template, 1, 1, "mat-icon", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](23, LoginComponent_mat_icon_23_Template, 1, 1, "mat-icon", 15);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](32, LoginComponent_mat_progress_spinner_32_Template, 1, 0, "mat-progress-spinner", 19);
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", ctx.form.get("emailAddress").hasError("required"));
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", ctx.form.get("hash").hasError("required"));
      ...
      data: {
        animation: [_vex_animations_fade_in_up_animation__WEBPACK_IMPORTED_MODULE_5__["fadeInUp400ms"]]
      },
      changeDetection: 0
    });
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](LoginComponent, [{
        ...
        args: [{
          ...
          animations: [_vex_animations_fade_in_up_animation__WEBPACK_IMPORTED_MODULE_5__["fadeInUp400ms"]]
        }]
      }], function () {
        return [{
