          ...
          this._viewportScrollSubscription = this._dragDropRegistry.scroll.subscribe(function (event) {
            if (_this16.isDragging()) {
              ...
              if (scrollDifference) {
                ...
                _this16._itemPositions.forEach(function (_ref3) {
                ...
                _this16._itemPositions.forEach(function (_ref4) {
                  var drag = _ref4.drag;
...
//# sourceMappingURL=default~admin-admin-calendar-admin-job-admin-job-module~pages-apps-scrumboard-scrumboard-module-es5.js.map